...
fn create_toml_depend_info()->String
{
    ...
    let serde_json_info = "serde_json = \"1.0.41\"\n".to_string();
    let fls_info = "fls = {git = \"https://github.com/FlexLinkSystem/fls.git\"}".to_string();

    let result = format!("{}{}{}{}", start, serde_info, serde_json_info, fls_info);
